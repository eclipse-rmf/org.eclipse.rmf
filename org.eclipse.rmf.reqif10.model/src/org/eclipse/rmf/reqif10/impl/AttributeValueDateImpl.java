 ...
 *   <li>{@link org.eclipse.rmf.reqif10.impl.AttributeValueDateImpl#getOwningDefinition <em>Owning Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeValueDateImpl extends AttributeValueSimpleImpl implements AttributeValueDate {
	 ...
	 * @generated
	 */
	public AttributeDefinitionDate getOwningDefinition() {
		if (eContainerFeatureID() != Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION) return null;
		return (AttributeDefinitionDate)eContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwningDefinition(AttributeDefinitionDate newOwningDefinition, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningDefinition, Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION, msgs);
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setOwningDefinition(AttributeDefinitionDate newOwningDefinition) {
		if (newOwningDefinition != eInternalContainer() || (eContainerFeatureID() != Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION && newOwningDefinition != null)) {
			...
			if (newOwningDefinition != null)
				msgs = ((InternalEObject)newOwningDefinition).eInverseAdd(this, Reqif10Package.ATTRIBUTE_DEFINITION_DATE__DEFAULT_VALUE, AttributeDefinitionDate.class, msgs);
			msgs = basicSetOwningDefinition(newOwningDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION, newOwningDefinition, newOwningDefinition));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwningDefinition((AttributeDefinitionDate)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION:
				return eInternalContainer().eInverseRemove(this, Reqif10Package.ATTRIBUTE_DEFINITION_DATE__DEFAULT_VALUE, AttributeDefinitionDate.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__DEFINITION:
				...
				return;
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION:
				setOwningDefinition((AttributeDefinitionDate)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__THE_VALUE:
				...
				return;
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__DEFINITION:
				setDefinition((AttributeDefinitionDate)null);
				return;
			case Reqif10Package.ATTRIBUTE_VALUE_DATE__OWNING_DEFINITION:
				setOwningDefinition((AttributeDefinitionDate)null);
				return;
		}
