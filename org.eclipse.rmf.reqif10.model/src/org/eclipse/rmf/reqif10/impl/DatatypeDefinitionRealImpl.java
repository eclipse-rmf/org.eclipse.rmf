...
public class DatatypeDefinitionRealImpl extends DatatypeDefinitionSimpleImpl implements DatatypeDefinitionReal {
	...
	public void setMax(Double newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Reqif10Package.DATATYPE_DEFINITION_REAL__MAX, oldMax, max));
	}
	...
	public void setMin(Double newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Reqif10Package.DATATYPE_DEFINITION_REAL__MIN, oldMin, min));
	}
