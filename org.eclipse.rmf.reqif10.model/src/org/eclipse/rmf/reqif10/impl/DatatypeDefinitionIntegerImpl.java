...
public class DatatypeDefinitionIntegerImpl extends DatatypeDefinitionSimpleImpl implements DatatypeDefinitionInteger {
	...
	public void setMax(BigInteger newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Reqif10Package.DATATYPE_DEFINITION_INTEGER__MAX, oldMax, max));
	}
	...
	public void setMin(BigInteger newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Reqif10Package.DATATYPE_DEFINITION_INTEGER__MIN, oldMin, min));
	}
