 ...
 * 
 */
public class ProrPropertyContentProvider2 extends AbstractContentProvider {
	...
	public ProrPropertyContentProvider2(AdapterFactory adapterFactory,
	...
	class Descriptor implements PropertyRow {
		...
		public AttributeValue getAttributeValue() {
			...
			String attributeDefinitionId = descriptor.getDescription(content);
			for (AttributeDefinition ad : ReqIF10Util.getSpecType(specElement)
					.getSpecAttributes()) {
				if (attributeDefinitionId.equals(ad.getIdentifier())) {
					return ProrUtil.createAttributeValue(ad);
				}
			}
			return null;
