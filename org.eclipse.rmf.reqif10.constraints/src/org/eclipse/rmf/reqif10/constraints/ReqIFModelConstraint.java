...
public abstract class ReqIFModelConstraint extends AbstractModelConstraint {
	...
	protected final static String constraintPrefix = "org.eclipse.rmf.reqif10.constraints."; //$NON-NLS-1$
		...
		try {
			...
			return ConstraintStatus
					.createStatus(
							...
							"Constraint "
									+ constraintId
									+ " was not evaluated: An Exception occured while validating {0}. This is likely because other constraints are not satified. ({1})",
							ctx.getTarget(), ex.toString());
		}
	}
