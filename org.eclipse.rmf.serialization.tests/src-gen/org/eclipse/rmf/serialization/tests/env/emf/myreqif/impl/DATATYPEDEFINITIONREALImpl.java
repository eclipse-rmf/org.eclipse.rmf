 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getALTERNATIVEID <em>ALTERNATIVEID</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getACCURACY <em>ACCURACY</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getDESC <em>DESC</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getIDENTIFIER <em>IDENTIFIER</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getLASTCHANGE <em>LASTCHANGE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getLONGNAME <em>LONGNAME</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getMAX <em>MAX</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.DATATYPEDEFINITIONREALImpl#getMIN <em>MIN</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DATATYPEDEFINITIONREALImpl extends EObjectImpl implements DATATYPEDEFINITIONREAL {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType3 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONREAL__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType3 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null)
				msgs = ((InternalEObject)aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.DATATYPEDEFINITIONREAL__ALTERNATIVEID, null, msgs);
			if (newALTERNATIVEID != null)
				msgs = ((InternalEObject)newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.DATATYPEDEFINITIONREAL__ALTERNATIVEID, null, msgs);
			msgs = basicSetALTERNATIVEID(newALTERNATIVEID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.DATATYPEDEFINITIONREAL__ALTERNATIVEID, newALTERNATIVEID, newALTERNATIVEID));
	}
