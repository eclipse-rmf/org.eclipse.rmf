...
import org.eclipse.rmf.serialization.tests.env.emf.myreqif.EMBEDDEDVALUE;
 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.PROPERTIESTypeImpl#getEMBEDDEDVALUE <em>EMBEDDEDVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PROPERTIESTypeImpl extends EObjectImpl implements PROPERTIESType {
	...
	public NotificationChain basicSetEMBEDDEDVALUE(EMBEDDEDVALUE newEMBEDDEDVALUE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, oldEMBEDDEDVALUE, newEMBEDDEDVALUE);
	...
	public void setEMBEDDEDVALUE(EMBEDDEDVALUE newEMBEDDEDVALUE) {
		if (newEMBEDDEDVALUE != eMBEDDEDVALUE) {
			...
			if (eMBEDDEDVALUE != null)
				msgs = ((InternalEObject)eMBEDDEDVALUE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, null, msgs);
			if (newEMBEDDEDVALUE != null)
				msgs = ((InternalEObject)newEMBEDDEDVALUE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, null, msgs);
