...
import org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECRELATIONTYPE;
 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getALTERNATIVEID <em>ALTERNATIVEID</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getSPECATTRIBUTES <em>SPECATTRIBUTES</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getDESC <em>DESC</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getIDENTIFIER <em>IDENTIFIER</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getLASTCHANGE <em>LASTCHANGE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SPECRELATIONTYPEImpl#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECRELATIONTYPEImpl extends EObjectImpl implements SPECRELATIONTYPE {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType14 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECRELATIONTYPE__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType14 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null)
				msgs = ((InternalEObject)aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECRELATIONTYPE__ALTERNATIVEID, null, msgs);
			if (newALTERNATIVEID != null)
				msgs = ((InternalEObject)newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECRELATIONTYPE__ALTERNATIVEID, null, msgs);
	...
	public NotificationChain basicSetSPECATTRIBUTES(SPECATTRIBUTESType newSPECATTRIBUTES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECRELATIONTYPE__SPECATTRIBUTES, oldSPECATTRIBUTES, newSPECATTRIBUTES);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSPECATTRIBUTES(SPECATTRIBUTESType newSPECATTRIBUTES) {
		if (newSPECATTRIBUTES != sPECATTRIBUTES) {
			...
			if (sPECATTRIBUTES != null)
				msgs = ((InternalEObject)sPECATTRIBUTES).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECRELATIONTYPE__SPECATTRIBUTES, null, msgs);
			if (newSPECATTRIBUTES != null)
				msgs = ((InternalEObject)newSPECATTRIBUTES).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.SPECRELATIONTYPE__SPECATTRIBUTES, null, msgs);
			msgs = basicSetSPECATTRIBUTES(newSPECATTRIBUTES, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SPECRELATIONTYPE__SPECATTRIBUTES, newSPECATTRIBUTES, newSPECATTRIBUTES));
	}
