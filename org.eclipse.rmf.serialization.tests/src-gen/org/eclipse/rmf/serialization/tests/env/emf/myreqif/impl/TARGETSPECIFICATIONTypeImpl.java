 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.TARGETSPECIFICATIONTypeImpl#getSPECIFICATIONREF <em>SPECIFICATIONREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TARGETSPECIFICATIONTypeImpl extends EObjectImpl implements TARGETSPECIFICATIONType {
	...
	protected EClass eStaticClass() {
		return MyreqifPackage.Literals.TARGETSPECIFICATION_TYPE;
	}
	...
	public void setSPECIFICATIONREF(String newSPECIFICATIONREF) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.TARGETSPECIFICATION_TYPE__SPECIFICATIONREF, oldSPECIFICATIONREF, sPECIFICATIONREF));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyreqifPackage.TARGETSPECIFICATION_TYPE__SPECIFICATIONREF:
