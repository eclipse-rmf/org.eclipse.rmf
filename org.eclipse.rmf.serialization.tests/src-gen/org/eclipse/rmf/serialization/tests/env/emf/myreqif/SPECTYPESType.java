 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECTYPESType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECTYPESType#getRELATIONGROUPTYPE <em>RELATIONGROUPTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECTYPESType#getSPECOBJECTTYPE <em>SPECOBJECTTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECTYPESType#getSPECRELATIONTYPE <em>SPECRELATIONTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECTYPESType#getSPECIFICATIONTYPE <em>SPECIFICATIONTYPE</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType()
...
public interface SPECTYPESType extends EObject {
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType_Group()
	 ...
	 * The list contents are of type {@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.RELATIONGROUPTYPE}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType_RELATIONGROUPTYPE()
	 ...
	 * The list contents are of type {@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECOBJECTTYPE}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType_SPECOBJECTTYPE()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECRELATIONTYPE}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType_SPECRELATIONTYPE()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECIFICATIONTYPE}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECTYPESType_SPECIFICATIONTYPE()
	 * @model containment="true" transient="true" volatile="true" derived="true"
