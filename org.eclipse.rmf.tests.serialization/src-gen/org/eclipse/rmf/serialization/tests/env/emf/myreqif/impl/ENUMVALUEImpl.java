...
import org.eclipse.rmf.serialization.tests.env.emf.myreqif.ENUMVALUE;
 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getALTERNATIVEID <em>ALTERNATIVEID</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getPROPERTIES <em>PROPERTIES</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getDESC <em>DESC</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getIDENTIFIER <em>IDENTIFIER</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getLASTCHANGE <em>LASTCHANGE</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.ENUMVALUEImpl#getLONGNAME <em>LONGNAME</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ENUMVALUEImpl extends EObjectImpl implements ENUMVALUE {
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEIDType2 newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ENUMVALUE__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
	...
	public void setALTERNATIVEID(ALTERNATIVEIDType2 newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null)
				msgs = ((InternalEObject)aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ENUMVALUE__ALTERNATIVEID, null, msgs);
			if (newALTERNATIVEID != null)
				msgs = ((InternalEObject)newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyreqifPackage.ENUMVALUE__ALTERNATIVEID, null, msgs);
	...
	public NotificationChain basicSetPROPERTIES(PROPERTIESType newPROPERTIES, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyreqifPackage.ENUMVALUE__PROPERTIES, oldPROPERTIES, newPROPERTIES);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
