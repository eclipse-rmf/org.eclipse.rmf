 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECRELATIONSType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.SPECRELATIONSType#getSPECRELATIONREF <em>SPECRELATIONREF</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECRELATIONSType()
...
public interface SPECRELATIONSType extends EObject {
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECRELATIONSType_Group()
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getSPECRELATIONSType_SPECRELATIONREF()
