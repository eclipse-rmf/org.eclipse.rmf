 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getTHEHEADER <em>THEHEADER</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getCORECONTENT <em>CORECONTENT</em>}</li>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getTOOLEXTENSIONS <em>TOOLEXTENSIONS</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getREQIF()
...
public interface REQIF extends EObject {
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getREQIF_THEHEADER()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getTHEHEADER <em>THEHEADER</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getREQIF_CORECONTENT()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getCORECONTENT <em>CORECONTENT</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.rmf.serialization.tests.env.emf.myreqif.MyreqifPackage#getREQIF_TOOLEXTENSIONS()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.REQIF#getTOOLEXTENSIONS <em>TOOLEXTENSIONS</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
