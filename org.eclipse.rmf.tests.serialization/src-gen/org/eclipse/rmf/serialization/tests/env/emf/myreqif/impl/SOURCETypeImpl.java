 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.serialization.tests.env.emf.myreqif.impl.SOURCETypeImpl#getSPECOBJECTREF <em>SPECOBJECTREF</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SOURCETypeImpl extends EObjectImpl implements SOURCEType {
	...
	public void setSPECOBJECTREF(String newSPECOBJECTREF) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyreqifPackage.SOURCE_TYPE__SPECOBJECTREF, oldSPECOBJECTREF, sPECOBJECTREF));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MyreqifPackage.SOURCE_TYPE__SPECOBJECTREF:
