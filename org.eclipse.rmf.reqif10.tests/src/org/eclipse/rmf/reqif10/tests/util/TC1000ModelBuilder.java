...
public class TC1000ModelBuilder extends SimpleModelBuilder {
	...
	public void createDatatypes() throws DatatypeConfigurationException {
		datatypeDefinitionBoolean = ReqIF10Factory.eINSTANCE
				.createDatatypeDefinitionBoolean();
		datatypeDefinitionBoolean
				.setIdentifier("ID_TC1000_DatatypeDefinitionBoolean");
		datatypeDefinitionBoolean
				.setLongName("TC1000 DatatypeDefinitionBoolean");
		datatypeDefinitionBoolean.setLastChange(getLastChangeDate());

		datatypeDefinitionInteger = ReqIF10Factory.eINSTANCE
				.createDatatypeDefinitionInteger();
		datatypeDefinitionInteger
				.setIdentifier("ID_TC1000_DatatypeDefinitionInteger");
		datatypeDefinitionInteger
		...
		datatypeDefinitionString = ReqIF10Factory.eINSTANCE
				.createDatatypeDefinitionString();
		datatypeDefinitionString
				.setIdentifier("ID_TC1000_DatatypeDefinitionString");
		...
		datatypeDefinitionReal = ReqIF10Factory.eINSTANCE
				.createDatatypeDefinitionReal();
		datatypeDefinitionReal
				.setIdentifier("ID_TC1000_DatatypeDefinitionReal");
	...
	public void createSpecObjectTypes() throws DatatypeConfigurationException {
		...
		System.out.println("saved Last Change Date: "
				+ specObjectType.getLastChange());

		attributeDefinitionBooleanTc1000t = ReqIF10Factory.eINSTANCE
				.createAttributeDefinitionBoolean();
		attributeDefinitionBooleanTc1000t
				.setIdentifier("ID_TC1000_AttributeDefinitionBoolean_TC1000T");
		...
		attributeDefinitionBooleanTc1000f = ReqIF10Factory.eINSTANCE
				.createAttributeDefinitionBoolean();
		attributeDefinitionBooleanTc1000f
				.setIdentifier("ID_TC1000_AttributeDefinitionBoolean_TC1000F");
	...
	public void createSpecObjects() throws DatatypeConfigurationException {
		...
		AttributeValueBoolean attributeValueBooleanTc1000t = ReqIF10Factory.eINSTANCE
				.createAttributeValueBoolean();
		attributeValueBooleanTc1000t
				.setDefinition(attributeDefinitionBooleanTc1000t);
		attributeValueBooleanTc1000t.setTheValue(true);

		AttributeValueBoolean attributeValueBooleanTc1000f = ReqIF10Factory.eINSTANCE
				.createAttributeValueBoolean();
		attributeValueBooleanTc1000f
				.setDefinition(attributeDefinitionBooleanTc1000f);
		attributeValueBooleanTc1000f.setTheValue(false);

		AttributeValueInteger attributeValueInteger = ReqIF10Factory.eINSTANCE
		...
		AttributeValueReal attributeValueReal = ReqIF10Factory.eINSTANCE
				.createAttributeValueReal();
		attributeValueReal.setDefinition(attributeDefinitionReal);
		attributeValueReal.setTheValue(1234.5);

		AttributeValueDate attributeValueDate = ReqIF10Factory.eINSTANCE
		...
		AttributeValueEnumeration attributeValueEnumeration = ReqIF10Factory.eINSTANCE
	...
	public SpecObject createTC1000SpecObject(String identifier,
			XMLGregorianCalendar lastChangeDate, boolean tc1000t, boolean tc1000f,
			BigInteger tc1000_integer, String tc1000_text, Double tc1000_real,
			XMLGregorianCalendar tc1000_lastChangeDate, EnumValue tc1000_enumvalue) {
