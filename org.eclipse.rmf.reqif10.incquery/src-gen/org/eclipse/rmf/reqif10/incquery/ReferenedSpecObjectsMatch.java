...
/**
 * Pattern-specific match representation of the org.eclipse.rmf.reqif10.incquery.referenedSpecObjects pattern,
 * to be used in conjunction with {@link ReferenedSpecObjectsMatcher}.
 * 
...
public abstract class ReferenedSpecObjectsMatch extends BasePatternMatch {
  private SpecObject fSpecObject;
  
  private static List<String> parameterNames = makeImmutableList("specObject");
  
  private ReferenedSpecObjectsMatch(final SpecObject pSpecObject) {
  ...
  public List<String> parameterNames() {
    return ReferenedSpecObjectsMatch.parameterNames;
  }
  ...
  @Override
  public ReferenedSpecObjectsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ReferenedSpecObjectsMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ReferenedSpecObjectsMatch other = (ReferenedSpecObjectsMatch) obj;
  ...
  @Override
  public ReferenedSpecObjectsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ReferenedSpecObjectsMatch newEmptyMatch() {
   ...
   * 
   */
  public static ReferenedSpecObjectsMatch newMutableMatch(final SpecObject pSpecObject) {
   ...
   * 
   */
  public static ReferenedSpecObjectsMatch newMatch(final SpecObject pSpecObject) {
    return new Immutable(pSpecObject);
  }
  
  private static final class Mutable extends ReferenedSpecObjectsMatch {
  ...
  private static final class Immutable extends ReferenedSpecObjectsMatch {
