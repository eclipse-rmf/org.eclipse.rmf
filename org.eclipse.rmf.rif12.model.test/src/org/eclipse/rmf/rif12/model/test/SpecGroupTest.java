...
public class SpecGroupTest extends Rif12ResourceTestBase{

	@Test
	public void testSpecObject() {

		String filename1 = "testdata/reqif-server/specGroupTest.rif";
		String filename2 = "testdata/output/specGroupTest.rif";
