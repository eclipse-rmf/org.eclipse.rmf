...
public class TransientSpecObjectsItemProvider extends TransientItemProvider {
	
	

	public TransientSpecObjectsItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) { 
	  return "Spec Objects (" +  ((ReqIFContent)getParent(object)).getSpecObjects().size() + ")";//$NON-NLS-1$
	} 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) { 
	  ...
	  newChildDescriptors.add(createChildParameter(ReqIF10Package.Literals.REQ_IF_CONTENT__SPEC_OBJECTS,ReqIF10Factory.eINSTANCE.createSpecObject()));
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location, int operations, int operation, Collection<?> collection) { 
	  if (new AddCommand(domain, (EObject) owner, ReqIF10Package.Literals.REQ_IF_CONTENT__SPEC_OBJECTS, collection).canExecute()) {
