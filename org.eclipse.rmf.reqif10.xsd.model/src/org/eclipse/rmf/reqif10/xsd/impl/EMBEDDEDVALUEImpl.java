 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.EMBEDDEDVALUEImpl#getKEY <em>KEY</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.EMBEDDEDVALUEImpl#getOTHERCONTENT <em>OTHERCONTENT</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EMBEDDEDVALUEImpl extends EObjectImpl implements EMBEDDEDVALUE {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.EMBEDDEDVALUE;
	}
	...
	public void setKEY(BigInteger newKEY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.EMBEDDEDVALUE__KEY, oldKEY, kEY));
	}
	...
	public void setOTHERCONTENT(String newOTHERCONTENT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.EMBEDDEDVALUE__OTHERCONTENT, oldOTHERCONTENT, oTHERCONTENT));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReqifPackage.EMBEDDEDVALUE__KEY:
				return getKEY();
			case ReqifPackage.EMBEDDEDVALUE__OTHERCONTENT:
