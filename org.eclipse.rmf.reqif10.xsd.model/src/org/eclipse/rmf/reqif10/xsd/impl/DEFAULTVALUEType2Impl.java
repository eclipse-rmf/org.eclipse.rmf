 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.DEFAULTVALUEType2Impl#getATTRIBUTEVALUEINTEGER <em>ATTRIBUTEVALUEINTEGER</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType2Impl extends EObjectImpl implements DEFAULTVALUEType2 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.DEFAULTVALUE_TYPE2;
	}
	...
	public NotificationChain basicSetATTRIBUTEVALUEINTEGER(ATTRIBUTEVALUEINTEGER newATTRIBUTEVALUEINTEGER, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, oldATTRIBUTEVALUEINTEGER, newATTRIBUTEVALUEINTEGER);
	...
	public void setATTRIBUTEVALUEINTEGER(ATTRIBUTEVALUEINTEGER newATTRIBUTEVALUEINTEGER) {
		if (newATTRIBUTEVALUEINTEGER != aTTRIBUTEVALUEINTEGER) {
			...
			if (aTTRIBUTEVALUEINTEGER != null)
				msgs = ((InternalEObject)aTTRIBUTEVALUEINTEGER).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, null, msgs);
			if (newATTRIBUTEVALUEINTEGER != null)
				msgs = ((InternalEObject)newATTRIBUTEVALUEINTEGER).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, null, msgs);
			msgs = basicSetATTRIBUTEVALUEINTEGER(newATTRIBUTEVALUEINTEGER, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER, newATTRIBUTEVALUEINTEGER, newATTRIBUTEVALUEINTEGER));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.DEFAULTVALUE_TYPE2__ATTRIBUTEVALUEINTEGER:
