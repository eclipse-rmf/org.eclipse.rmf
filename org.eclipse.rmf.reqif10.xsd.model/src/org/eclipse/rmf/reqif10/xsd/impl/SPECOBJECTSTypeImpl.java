 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECOBJECTSTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECOBJECTSTypeImpl#getSPECOBJECT <em>SPECOBJECT</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECOBJECTSTypeImpl extends EObjectImpl implements SPECOBJECTSType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECOBJECTS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECOBJECTS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<SPECOBJECT> getSPECOBJECT() {
		return getGroup().list(ReqifPackage.Literals.SPECOBJECTS_TYPE__SPECOBJECT);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECOBJECTS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECOBJECTS_TYPE__SPECOBJECT:
