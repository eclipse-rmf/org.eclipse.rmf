 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUESTRINGImpl#getDEFINITION <em>DEFINITION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUESTRINGImpl#getTHEVALUE <em>THEVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ATTRIBUTEVALUESTRINGImpl extends EObjectImpl implements ATTRIBUTEVALUESTRING {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.ATTRIBUTEVALUESTRING;
	}
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType2 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUESTRING__DEFINITION, oldDEFINITION, newDEFINITION);
	...
	public void setDEFINITION(DEFINITIONType2 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null)
				msgs = ((InternalEObject)dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUESTRING__DEFINITION, null, msgs);
			if (newDEFINITION != null)
				msgs = ((InternalEObject)newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUESTRING__DEFINITION, null, msgs);
			msgs = basicSetDEFINITION(newDEFINITION, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUESTRING__DEFINITION, newDEFINITION, newDEFINITION));
	}
	...
	public void setTHEVALUE(String newTHEVALUE) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUESTRING__THEVALUE, oldTHEVALUE, tHEVALUE));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.ATTRIBUTEVALUESTRING__DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReqifPackage.ATTRIBUTEVALUESTRING__THEVALUE:
				return getTHEVALUE();
		}
