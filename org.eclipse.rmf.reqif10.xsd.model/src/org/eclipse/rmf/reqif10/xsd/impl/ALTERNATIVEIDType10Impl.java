 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ALTERNATIVEIDType10Impl#getALTERNATIVEID <em>ALTERNATIVEID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ALTERNATIVEIDType10Impl extends EObjectImpl implements ALTERNATIVEIDType10 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.ALTERNATIVEID_TYPE10;
	}
	...
	public NotificationChain basicSetALTERNATIVEID(ALTERNATIVEID newALTERNATIVEID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.ALTERNATIVEID_TYPE10__ALTERNATIVEID, oldALTERNATIVEID, newALTERNATIVEID);
	...
	public void setALTERNATIVEID(ALTERNATIVEID newALTERNATIVEID) {
		if (newALTERNATIVEID != aLTERNATIVEID) {
			...
			if (aLTERNATIVEID != null)
				msgs = ((InternalEObject)aLTERNATIVEID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ALTERNATIVEID_TYPE10__ALTERNATIVEID, null, msgs);
			if (newALTERNATIVEID != null)
				msgs = ((InternalEObject)newALTERNATIVEID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ALTERNATIVEID_TYPE10__ALTERNATIVEID, null, msgs);
			msgs = basicSetALTERNATIVEID(newALTERNATIVEID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ALTERNATIVEID_TYPE10__ALTERNATIVEID, newALTERNATIVEID, newALTERNATIVEID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.ALTERNATIVEID_TYPE10__ALTERNATIVEID:
