 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.DEFAULTVALUEType4Impl#getATTRIBUTEVALUESTRING <em>ATTRIBUTEVALUESTRING</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType4Impl extends EObjectImpl implements DEFAULTVALUEType4 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.DEFAULTVALUE_TYPE4;
	}
	...
	public NotificationChain basicSetATTRIBUTEVALUESTRING(ATTRIBUTEVALUESTRING newATTRIBUTEVALUESTRING, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE4__ATTRIBUTEVALUESTRING, oldATTRIBUTEVALUESTRING, newATTRIBUTEVALUESTRING);
	...
	public void setATTRIBUTEVALUESTRING(ATTRIBUTEVALUESTRING newATTRIBUTEVALUESTRING) {
		if (newATTRIBUTEVALUESTRING != aTTRIBUTEVALUESTRING) {
			...
			if (aTTRIBUTEVALUESTRING != null)
				msgs = ((InternalEObject)aTTRIBUTEVALUESTRING).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE4__ATTRIBUTEVALUESTRING, null, msgs);
			if (newATTRIBUTEVALUESTRING != null)
				msgs = ((InternalEObject)newATTRIBUTEVALUESTRING).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE4__ATTRIBUTEVALUESTRING, null, msgs);
			msgs = basicSetATTRIBUTEVALUESTRING(newATTRIBUTEVALUESTRING, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE4__ATTRIBUTEVALUESTRING, newATTRIBUTEVALUESTRING, newATTRIBUTEVALUESTRING));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.DEFAULTVALUE_TYPE4__ATTRIBUTEVALUESTRING:
