 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONBOOLEAN <em>ATTRIBUTEDEFINITIONBOOLEAN</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONDATE <em>ATTRIBUTEDEFINITIONDATE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONENUMERATION <em>ATTRIBUTEDEFINITIONENUMERATION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONINTEGER <em>ATTRIBUTEDEFINITIONINTEGER</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONREAL <em>ATTRIBUTEDEFINITIONREAL</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONSTRING <em>ATTRIBUTEDEFINITIONSTRING</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType1Impl#getATTRIBUTEDEFINITIONXHTML <em>ATTRIBUTEDEFINITIONXHTML</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECATTRIBUTESType1Impl extends EObjectImpl implements SPECATTRIBUTESType1 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECATTRIBUTES_TYPE1;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECATTRIBUTES_TYPE1__GROUP);
		}
		return group;
	}
	...
	public EList<ATTRIBUTEDEFINITIONBOOLEAN> getATTRIBUTEDEFINITIONBOOLEAN() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONBOOLEAN);
	}
	...
	public EList<ATTRIBUTEDEFINITIONDATE> getATTRIBUTEDEFINITIONDATE() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONDATE);
	}
	...
	public EList<ATTRIBUTEDEFINITIONENUMERATION> getATTRIBUTEDEFINITIONENUMERATION() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONENUMERATION);
	}
	...
	public EList<ATTRIBUTEDEFINITIONINTEGER> getATTRIBUTEDEFINITIONINTEGER() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONINTEGER);
	}
	...
	public EList<ATTRIBUTEDEFINITIONREAL> getATTRIBUTEDEFINITIONREAL() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONREAL);
	}
	...
	public EList<ATTRIBUTEDEFINITIONSTRING> getATTRIBUTEDEFINITIONSTRING() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONSTRING);
	}
	...
	public EList<ATTRIBUTEDEFINITIONXHTML> getATTRIBUTEDEFINITIONXHTML() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONXHTML);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECATTRIBUTES_TYPE1__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONBOOLEAN:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONBOOLEAN()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONDATE:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONDATE()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONENUMERATION:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONENUMERATION()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONINTEGER:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONINTEGER()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONREAL:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONREAL()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONSTRING:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONSTRING()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE1__ATTRIBUTEDEFINITIONXHTML:
