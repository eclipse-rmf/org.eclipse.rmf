 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECTYPESTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECTYPESTypeImpl#getRELATIONGROUPTYPE <em>RELATIONGROUPTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECTYPESTypeImpl#getSPECOBJECTTYPE <em>SPECOBJECTTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECTYPESTypeImpl#getSPECRELATIONTYPE <em>SPECRELATIONTYPE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECTYPESTypeImpl#getSPECIFICATIONTYPE <em>SPECIFICATIONTYPE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECTYPESTypeImpl extends EObjectImpl implements SPECTYPESType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECTYPES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECTYPES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<RELATIONGROUPTYPE> getRELATIONGROUPTYPE() {
		return getGroup().list(ReqifPackage.Literals.SPECTYPES_TYPE__RELATIONGROUPTYPE);
	}
	...
	public EList<SPECOBJECTTYPE> getSPECOBJECTTYPE() {
		return getGroup().list(ReqifPackage.Literals.SPECTYPES_TYPE__SPECOBJECTTYPE);
	}
	...
	public EList<SPECRELATIONTYPE> getSPECRELATIONTYPE() {
		return getGroup().list(ReqifPackage.Literals.SPECTYPES_TYPE__SPECRELATIONTYPE);
	}
	...
	public EList<SPECIFICATIONTYPE> getSPECIFICATIONTYPE() {
		return getGroup().list(ReqifPackage.Literals.SPECTYPES_TYPE__SPECIFICATIONTYPE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECTYPES_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECTYPES_TYPE__RELATIONGROUPTYPE:
				return ((InternalEList<?>)getRELATIONGROUPTYPE()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECTYPES_TYPE__SPECOBJECTTYPE:
				return ((InternalEList<?>)getSPECOBJECTTYPE()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECTYPES_TYPE__SPECRELATIONTYPE:
				return ((InternalEList<?>)getSPECRELATIONTYPE()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECTYPES_TYPE__SPECIFICATIONTYPE:
