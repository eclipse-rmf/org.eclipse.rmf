 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.DEFAULTVALUEType3Impl#getATTRIBUTEVALUEREAL <em>ATTRIBUTEVALUEREAL</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType3Impl extends EObjectImpl implements DEFAULTVALUEType3 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.DEFAULTVALUE_TYPE3;
	}
	...
	public NotificationChain basicSetATTRIBUTEVALUEREAL(ATTRIBUTEVALUEREAL newATTRIBUTEVALUEREAL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, oldATTRIBUTEVALUEREAL, newATTRIBUTEVALUEREAL);
	...
	public void setATTRIBUTEVALUEREAL(ATTRIBUTEVALUEREAL newATTRIBUTEVALUEREAL) {
		if (newATTRIBUTEVALUEREAL != aTTRIBUTEVALUEREAL) {
			...
			if (aTTRIBUTEVALUEREAL != null)
				msgs = ((InternalEObject)aTTRIBUTEVALUEREAL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, null, msgs);
			if (newATTRIBUTEVALUEREAL != null)
				msgs = ((InternalEObject)newATTRIBUTEVALUEREAL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, null, msgs);
			msgs = basicSetATTRIBUTEVALUEREAL(newATTRIBUTEVALUEREAL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL, newATTRIBUTEVALUEREAL, newATTRIBUTEVALUEREAL));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.DEFAULTVALUE_TYPE3__ATTRIBUTEVALUEREAL:
