 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUEBOOLEANImpl#getDEFINITION <em>DEFINITION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUEBOOLEANImpl#isTHEVALUE <em>THEVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ATTRIBUTEVALUEBOOLEANImpl extends EObjectImpl implements ATTRIBUTEVALUEBOOLEAN {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.ATTRIBUTEVALUEBOOLEAN;
	}
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType6 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION, oldDEFINITION, newDEFINITION);
	...
	public void setDEFINITION(DEFINITIONType6 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null)
				msgs = ((InternalEObject)dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION, null, msgs);
			if (newDEFINITION != null)
				msgs = ((InternalEObject)newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION, null, msgs);
			msgs = basicSetDEFINITION(newDEFINITION, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION, newDEFINITION, newDEFINITION));
	}
	...
	public void setTHEVALUE(boolean newTHEVALUE) {
		...
		tHEVALUEESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEBOOLEAN__THEVALUE, oldTHEVALUE, tHEVALUE, !oldTHEVALUEESet));
	}
	...
	public void unsetTHEVALUE() {
		...
		tHEVALUEESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReqifPackage.ATTRIBUTEVALUEBOOLEAN__THEVALUE, oldTHEVALUE, THEVALUE_EDEFAULT, oldTHEVALUEESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.ATTRIBUTEVALUEBOOLEAN__DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReqifPackage.ATTRIBUTEVALUEBOOLEAN__THEVALUE:
				return isTHEVALUE();
		}
