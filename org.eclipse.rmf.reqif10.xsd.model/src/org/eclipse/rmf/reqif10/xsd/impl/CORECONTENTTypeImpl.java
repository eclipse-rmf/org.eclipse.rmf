 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.CORECONTENTTypeImpl#getREQIFCONTENT <em>REQIFCONTENT</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CORECONTENTTypeImpl extends EObjectImpl implements CORECONTENTType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.CORECONTENT_TYPE;
	}
	...
	public NotificationChain basicSetREQIFCONTENT(REQIFCONTENT newREQIFCONTENT, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.CORECONTENT_TYPE__REQIFCONTENT, oldREQIFCONTENT, newREQIFCONTENT);
	...
	public void setREQIFCONTENT(REQIFCONTENT newREQIFCONTENT) {
		if (newREQIFCONTENT != rEQIFCONTENT) {
			...
			if (rEQIFCONTENT != null)
				msgs = ((InternalEObject)rEQIFCONTENT).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.CORECONTENT_TYPE__REQIFCONTENT, null, msgs);
			if (newREQIFCONTENT != null)
				msgs = ((InternalEObject)newREQIFCONTENT).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.CORECONTENT_TYPE__REQIFCONTENT, null, msgs);
			msgs = basicSetREQIFCONTENT(newREQIFCONTENT, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.CORECONTENT_TYPE__REQIFCONTENT, newREQIFCONTENT, newREQIFCONTENT));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.CORECONTENT_TYPE__REQIFCONTENT:
