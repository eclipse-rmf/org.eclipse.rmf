 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECIFIEDVALUESTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECIFIEDVALUESTypeImpl#getENUMVALUE <em>ENUMVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECIFIEDVALUESTypeImpl extends EObjectImpl implements SPECIFIEDVALUESType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECIFIEDVALUES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECIFIEDVALUES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ENUMVALUE> getENUMVALUE() {
		return getGroup().list(ReqifPackage.Literals.SPECIFIEDVALUES_TYPE__ENUMVALUE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECIFIEDVALUES_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECIFIEDVALUES_TYPE__ENUMVALUE:
