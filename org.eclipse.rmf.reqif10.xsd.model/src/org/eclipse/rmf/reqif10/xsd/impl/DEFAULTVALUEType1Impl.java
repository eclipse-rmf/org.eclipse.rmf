 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.DEFAULTVALUEType1Impl#getATTRIBUTEVALUEENUMERATION <em>ATTRIBUTEVALUEENUMERATION</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType1Impl extends EObjectImpl implements DEFAULTVALUEType1 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.DEFAULTVALUE_TYPE1;
	}
	...
	public NotificationChain basicSetATTRIBUTEVALUEENUMERATION(ATTRIBUTEVALUEENUMERATION newATTRIBUTEVALUEENUMERATION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, oldATTRIBUTEVALUEENUMERATION, newATTRIBUTEVALUEENUMERATION);
	...
	public void setATTRIBUTEVALUEENUMERATION(ATTRIBUTEVALUEENUMERATION newATTRIBUTEVALUEENUMERATION) {
		if (newATTRIBUTEVALUEENUMERATION != aTTRIBUTEVALUEENUMERATION) {
			...
			if (aTTRIBUTEVALUEENUMERATION != null)
				msgs = ((InternalEObject)aTTRIBUTEVALUEENUMERATION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, null, msgs);
			if (newATTRIBUTEVALUEENUMERATION != null)
				msgs = ((InternalEObject)newATTRIBUTEVALUEENUMERATION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, null, msgs);
			msgs = basicSetATTRIBUTEVALUEENUMERATION(newATTRIBUTEVALUEENUMERATION, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION, newATTRIBUTEVALUEENUMERATION, newATTRIBUTEVALUEENUMERATION));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.DEFAULTVALUE_TYPE1__ATTRIBUTEVALUEENUMERATION:
