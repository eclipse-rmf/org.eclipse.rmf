 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONBOOLEAN <em>ATTRIBUTEDEFINITIONBOOLEAN</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONDATE <em>ATTRIBUTEDEFINITIONDATE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONENUMERATION <em>ATTRIBUTEDEFINITIONENUMERATION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONINTEGER <em>ATTRIBUTEDEFINITIONINTEGER</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONREAL <em>ATTRIBUTEDEFINITIONREAL</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONSTRING <em>ATTRIBUTEDEFINITIONSTRING</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECATTRIBUTESType2Impl#getATTRIBUTEDEFINITIONXHTML <em>ATTRIBUTEDEFINITIONXHTML</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECATTRIBUTESType2Impl extends EObjectImpl implements SPECATTRIBUTESType2 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECATTRIBUTES_TYPE2;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECATTRIBUTES_TYPE2__GROUP);
		}
		return group;
	}
	...
	public EList<ATTRIBUTEDEFINITIONBOOLEAN> getATTRIBUTEDEFINITIONBOOLEAN() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONBOOLEAN);
	}
	...
	public EList<ATTRIBUTEDEFINITIONDATE> getATTRIBUTEDEFINITIONDATE() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONDATE);
	}
	...
	public EList<ATTRIBUTEDEFINITIONENUMERATION> getATTRIBUTEDEFINITIONENUMERATION() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONENUMERATION);
	}
	...
	public EList<ATTRIBUTEDEFINITIONINTEGER> getATTRIBUTEDEFINITIONINTEGER() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONINTEGER);
	}
	...
	public EList<ATTRIBUTEDEFINITIONREAL> getATTRIBUTEDEFINITIONREAL() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONREAL);
	}
	...
	public EList<ATTRIBUTEDEFINITIONSTRING> getATTRIBUTEDEFINITIONSTRING() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONSTRING);
	}
	...
	public EList<ATTRIBUTEDEFINITIONXHTML> getATTRIBUTEDEFINITIONXHTML() {
		return getGroup().list(ReqifPackage.Literals.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONXHTML);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECATTRIBUTES_TYPE2__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONBOOLEAN:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONBOOLEAN()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONDATE:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONDATE()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONENUMERATION:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONENUMERATION()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONINTEGER:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONINTEGER()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONREAL:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONREAL()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONSTRING:
				return ((InternalEList<?>)getATTRIBUTEDEFINITIONSTRING()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECATTRIBUTES_TYPE2__ATTRIBUTEDEFINITIONXHTML:
