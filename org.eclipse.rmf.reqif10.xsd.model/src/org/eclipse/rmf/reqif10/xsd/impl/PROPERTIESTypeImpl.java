...
import org.eclipse.rmf.reqif10.xsd.EMBEDDEDVALUE;
 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.PROPERTIESTypeImpl#getEMBEDDEDVALUE <em>EMBEDDEDVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PROPERTIESTypeImpl extends EObjectImpl implements PROPERTIESType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.PROPERTIES_TYPE;
	}
	...
	public NotificationChain basicSetEMBEDDEDVALUE(EMBEDDEDVALUE newEMBEDDEDVALUE, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, oldEMBEDDEDVALUE, newEMBEDDEDVALUE);
	...
	public void setEMBEDDEDVALUE(EMBEDDEDVALUE newEMBEDDEDVALUE) {
		if (newEMBEDDEDVALUE != eMBEDDEDVALUE) {
			...
			if (eMBEDDEDVALUE != null)
				msgs = ((InternalEObject)eMBEDDEDVALUE).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, null, msgs);
			if (newEMBEDDEDVALUE != null)
				msgs = ((InternalEObject)newEMBEDDEDVALUE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, null, msgs);
			msgs = basicSetEMBEDDEDVALUE(newEMBEDDEDVALUE, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE, newEMBEDDEDVALUE, newEMBEDDEDVALUE));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.PROPERTIES_TYPE__EMBEDDEDVALUE:
