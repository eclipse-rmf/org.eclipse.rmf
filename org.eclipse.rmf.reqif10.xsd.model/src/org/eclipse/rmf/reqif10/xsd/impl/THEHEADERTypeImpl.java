 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.THEHEADERTypeImpl#getREQIFHEADER <em>REQIFHEADER</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class THEHEADERTypeImpl extends EObjectImpl implements THEHEADERType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.THEHEADER_TYPE;
	}
	...
	public NotificationChain basicSetREQIFHEADER(REQIFHEADER newREQIFHEADER, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.THEHEADER_TYPE__REQIFHEADER, oldREQIFHEADER, newREQIFHEADER);
	...
	public void setREQIFHEADER(REQIFHEADER newREQIFHEADER) {
		if (newREQIFHEADER != rEQIFHEADER) {
			...
			if (rEQIFHEADER != null)
				msgs = ((InternalEObject)rEQIFHEADER).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.THEHEADER_TYPE__REQIFHEADER, null, msgs);
			if (newREQIFHEADER != null)
				msgs = ((InternalEObject)newREQIFHEADER).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.THEHEADER_TYPE__REQIFHEADER, null, msgs);
			msgs = basicSetREQIFHEADER(newREQIFHEADER, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.THEHEADER_TYPE__REQIFHEADER, newREQIFHEADER, newREQIFHEADER));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.THEHEADER_TYPE__REQIFHEADER:
