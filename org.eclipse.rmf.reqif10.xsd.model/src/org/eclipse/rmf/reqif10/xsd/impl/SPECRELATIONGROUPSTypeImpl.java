 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECRELATIONGROUPSTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECRELATIONGROUPSTypeImpl#getRELATIONGROUP <em>RELATIONGROUP</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECRELATIONGROUPSTypeImpl extends EObjectImpl implements SPECRELATIONGROUPSType {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECRELATIONGROUPS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECRELATIONGROUPS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<RELATIONGROUP> getRELATIONGROUP() {
		return getGroup().list(ReqifPackage.Literals.SPECRELATIONGROUPS_TYPE__RELATIONGROUP);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECRELATIONGROUPS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECRELATIONGROUPS_TYPE__RELATIONGROUP:
