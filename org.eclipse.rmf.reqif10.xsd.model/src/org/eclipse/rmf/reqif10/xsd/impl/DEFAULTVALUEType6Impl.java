 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.DEFAULTVALUEType6Impl#getATTRIBUTEVALUEBOOLEAN <em>ATTRIBUTEVALUEBOOLEAN</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DEFAULTVALUEType6Impl extends EObjectImpl implements DEFAULTVALUEType6 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.DEFAULTVALUE_TYPE6;
	}
	...
	public NotificationChain basicSetATTRIBUTEVALUEBOOLEAN(ATTRIBUTEVALUEBOOLEAN newATTRIBUTEVALUEBOOLEAN, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, oldATTRIBUTEVALUEBOOLEAN, newATTRIBUTEVALUEBOOLEAN);
	...
	public void setATTRIBUTEVALUEBOOLEAN(ATTRIBUTEVALUEBOOLEAN newATTRIBUTEVALUEBOOLEAN) {
		if (newATTRIBUTEVALUEBOOLEAN != aTTRIBUTEVALUEBOOLEAN) {
			...
			if (aTTRIBUTEVALUEBOOLEAN != null)
				msgs = ((InternalEObject)aTTRIBUTEVALUEBOOLEAN).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, null, msgs);
			if (newATTRIBUTEVALUEBOOLEAN != null)
				msgs = ((InternalEObject)newATTRIBUTEVALUEBOOLEAN).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, null, msgs);
			msgs = basicSetATTRIBUTEVALUEBOOLEAN(newATTRIBUTEVALUEBOOLEAN, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN, newATTRIBUTEVALUEBOOLEAN, newATTRIBUTEVALUEBOOLEAN));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.DEFAULTVALUE_TYPE6__ATTRIBUTEVALUEBOOLEAN:
