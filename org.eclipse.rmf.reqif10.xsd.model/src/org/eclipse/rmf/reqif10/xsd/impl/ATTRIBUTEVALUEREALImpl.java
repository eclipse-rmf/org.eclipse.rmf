 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUEREALImpl#getDEFINITION <em>DEFINITION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.ATTRIBUTEVALUEREALImpl#getTHEVALUE <em>THEVALUE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ATTRIBUTEVALUEREALImpl extends EObjectImpl implements ATTRIBUTEVALUEREAL {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.ATTRIBUTEVALUEREAL;
	}
	...
	public NotificationChain basicSetDEFINITION(DEFINITIONType4 newDEFINITION, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEREAL__DEFINITION, oldDEFINITION, newDEFINITION);
	...
	public void setDEFINITION(DEFINITIONType4 newDEFINITION) {
		if (newDEFINITION != dEFINITION) {
			...
			if (dEFINITION != null)
				msgs = ((InternalEObject)dEFINITION).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUEREAL__DEFINITION, null, msgs);
			if (newDEFINITION != null)
				msgs = ((InternalEObject)newDEFINITION).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqifPackage.ATTRIBUTEVALUEREAL__DEFINITION, null, msgs);
			msgs = basicSetDEFINITION(newDEFINITION, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEREAL__DEFINITION, newDEFINITION, newDEFINITION));
	}
	...
	public void setTHEVALUE(double newTHEVALUE) {
		...
		tHEVALUEESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.ATTRIBUTEVALUEREAL__THEVALUE, oldTHEVALUE, tHEVALUE, !oldTHEVALUEESet));
	}
	...
	public void unsetTHEVALUE() {
		...
		tHEVALUEESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReqifPackage.ATTRIBUTEVALUEREAL__THEVALUE, oldTHEVALUE, THEVALUE_EDEFAULT, oldTHEVALUEESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.ATTRIBUTEVALUEREAL__DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReqifPackage.ATTRIBUTEVALUEREAL__THEVALUE:
				return getTHEVALUE();
		}
