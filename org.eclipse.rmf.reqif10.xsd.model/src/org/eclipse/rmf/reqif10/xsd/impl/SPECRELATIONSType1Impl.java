 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECRELATIONSType1Impl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.SPECRELATIONSType1Impl#getSPECRELATION <em>SPECRELATION</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPECRELATIONSType1Impl extends EObjectImpl implements SPECRELATIONSType1 {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.SPECRELATIONS_TYPE1;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ReqifPackage.SPECRELATIONS_TYPE1__GROUP);
		}
		return group;
	}
	...
	public EList<SPECRELATION> getSPECRELATION() {
		return getGroup().list(ReqifPackage.Literals.SPECRELATIONS_TYPE1__SPECRELATION);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqifPackage.SPECRELATIONS_TYPE1__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ReqifPackage.SPECRELATIONS_TYPE1__SPECRELATION:
