...
import org.eclipse.rmf.reqif10.xsd.REQIFHEADER;
 ...
 * <ul>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getCOMMENT <em>COMMENT</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getCREATIONTIME <em>CREATIONTIME</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getREPOSITORYID <em>REPOSITORYID</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getREQIFTOOLID <em>REQIFTOOLID</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getREQIFVERSION <em>REQIFVERSION</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getSOURCETOOLID <em>SOURCETOOLID</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getTITLE <em>TITLE</em>}</li>
 *   <li>{@link org.eclipse.rmf.reqif10.xsd.impl.REQIFHEADERImpl#getIDENTIFIER <em>IDENTIFIER</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class REQIFHEADERImpl extends EObjectImpl implements REQIFHEADER {
	...
	protected EClass eStaticClass() {
		return ReqifPackage.Literals.REQIFHEADER;
	}
	...
	public void setCOMMENT(String newCOMMENT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__COMMENT, oldCOMMENT, cOMMENT));
	}
	...
	public void setCREATIONTIME(XMLGregorianCalendar newCREATIONTIME) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__CREATIONTIME, oldCREATIONTIME, cREATIONTIME));
	}
	...
	public void setREPOSITORYID(String newREPOSITORYID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__REPOSITORYID, oldREPOSITORYID, rEPOSITORYID));
	}
	...
	public void setREQIFTOOLID(String newREQIFTOOLID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__REQIFTOOLID, oldREQIFTOOLID, rEQIFTOOLID));
	}
	...
	public void setREQIFVERSION(String newREQIFVERSION) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__REQIFVERSION, oldREQIFVERSION, rEQIFVERSION, !oldREQIFVERSIONESet));
	}
	...
	public void unsetREQIFVERSION() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReqifPackage.REQIFHEADER__REQIFVERSION, oldREQIFVERSION, REQIFVERSION_EDEFAULT, oldREQIFVERSIONESet));
	}
	...
	public void setSOURCETOOLID(String newSOURCETOOLID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__SOURCETOOLID, oldSOURCETOOLID, sOURCETOOLID));
	}
	...
	public void setTITLE(String newTITLE) {
		...
		tITLE = newTITLE;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__TITLE, oldTITLE, tITLE));
	}
	...
	public void setIDENTIFIER(String newIDENTIFIER) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqifPackage.REQIFHEADER__IDENTIFIER, oldIDENTIFIER, iDENTIFIER));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReqifPackage.REQIFHEADER__COMMENT:
				return getCOMMENT();
			case ReqifPackage.REQIFHEADER__CREATIONTIME:
				return getCREATIONTIME();
			case ReqifPackage.REQIFHEADER__REPOSITORYID:
				return getREPOSITORYID();
			case ReqifPackage.REQIFHEADER__REQIFTOOLID:
				return getREQIFTOOLID();
			case ReqifPackage.REQIFHEADER__REQIFVERSION:
				return getREQIFVERSION();
			case ReqifPackage.REQIFHEADER__SOURCETOOLID:
				return getSOURCETOOLID();
			case ReqifPackage.REQIFHEADER__TITLE:
				return getTITLE();
			case ReqifPackage.REQIFHEADER__IDENTIFIER:
